...
X = data.drop(columns=["G2",target_column])
...
model = Sequential([
    Dense(58, input_dim=X_train.shape[1], activation='sigmoid'),
    Dropout(0.2),
...
print(f"Root Mean Squared Error (RMSE): {(mse**0.5):.2f}, RMSE of the paper: 1.88")
