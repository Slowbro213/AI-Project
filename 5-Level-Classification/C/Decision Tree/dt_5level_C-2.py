...
# Define features (all features except G1 and G2) and target
...
features.remove('G1')  # Exclude G1 for Task C
features.remove('G2')  # Exclude G2 for Task C
...
classifier = DecisionTreeClassifier(random_state=42, max_depth=9)  # Start with max_depth=3
...
graph.render("decision_tree_5_level_case_C", format="png", cleanup=True)
print("5-Level classification decision tree visualization saved as 'decision_tree_5_level_case_C.png'.")

# Print the features for verification
# print(f"Features for Task C: {list(X.columns)}")

# Analyze and print feature importances
