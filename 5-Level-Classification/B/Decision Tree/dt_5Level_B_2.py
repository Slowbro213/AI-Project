...
# Define features and exclude G3 and one-hot encoded G3_class columns
...
features.remove('G2')  # Task B excludes G2 (keep G1)
...
# graph.render("decision_tree_5_level_case_B", format="png", cleanup=True)
# print("5-Level classification decision tree visualization saved as 'decision_tree_5_level_case_B.png'.")

# print(f"Features for Task B: {list(X.columns)}")