...
# Define features (all features except G1 and G2)
...
features.remove('G1')       # Exclude G1
features.remove('G2')       # Exclude G2
...
classifier = DecisionTreeClassifier(random_state=42, max_depth=2)  # Start with max_depth=2
...
graph.render("decision_tree_binary_case_C", format="png", cleanup=True)
print("Binary classification decision tree visualization saved as 'decision_tree_binary_case_C.png'.")
