...
classifier = DecisionTreeClassifier(random_state=42, max_depth=2)  # Use max_depth=2 as per Task A
...
graph.render("decision_tree_binary_case_B", format="png", cleanup=True)
print("Binary classification decision tree visualization saved as 'decision_tree_binary_case_B.png'.")
